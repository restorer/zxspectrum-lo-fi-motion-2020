...
pages
    lua allpass
        ...
        make_page(0x0040, { { " 0 ", 3, 0, 0, 7 } })
        make_page(0x0040, { { " 1 ", 3, 0, 1, 7 } })
        make_page(0x0040, { { " 2 ", 3, 0, 2, 7 } })
        make_page(0x0040, { { " 3 ", 3, 0, 3, 7 } })
        make_page(0x0040, { { " 4 ", 3, 0, 4, 0 } })
        make_page(0x0040, { { " 5 ", 3, 0, 5, 0 } })
        make_page(0x0040, { { " 6 ", 3, 0, 6, 0 } })
        make_page(0x0040, { { " 7 ", 3, 0, 7, 0 } })
        ...
        make_page(0x0010, { { " A NEW DEMO ", 3, 0, 2, 7 } })
        make_page(0x0010, { { " A NEW DEMO ", 1, 0, 2, 7 }, { " ESPECIALLY FOR ", 5, 0, 5, 0 } })
        make_page(0x0060, { { " A NEW DEMO ", 0, 0, 2, 7 }, { " ESPECIALLY FOR ", 3, 0, 5, 0 }, { " DIHALT WINTER 2020 ", 6, 0, 1, 7 } })
        ...
        make_page(0x0080, { { " TIME HAS COME ", 104, 1006, 2, 7 } })
        make_page(0x0080, { { " THE DEMO IS OVER ", 102, 1008, 0, 7 } })

        sj.parse_line(".loop")

        make_page(0x0080, { { " AND NOW ", 0, 0, 5, 0 } })
        make_page(0x0080, { { " WE WANT TO ", 2, 0, 4, 0 } })
        make_page(0x0080, { { " SEND GREETZ ", 4, 0, 2, 7 } })
        make_page(0x0080, { { " TO THE LEGENDS ", 6, 0, 1, 7 } })

        make_page(0x0010, { { " GREETZ: 0 ", 3, 0, 0, 7 } })
        make_page(0x0010, { { " GREETZ: 1 ", 3, 0, 1, 7 } })
        make_page(0x0010, { { " GREETZ: 2 ", 3, 0, 2, 7 } })
        make_page(0x0010, { { " GREETZ: 3 ", 3, 0, 3, 7 } })
        make_page(0x0010, { { " GREETZ: 4 ", 3, 0, 4, 0 } })
        make_page(0x0010, { { " GREETZ: 5 ", 3, 0, 5, 0 } })
        make_page(0x0010, { { " GREETZ: 6 ", 3, 0, 6, 0 } })
        make_page(0x0010, { { " GREETZ: 7 ", 3, 0, 7, 0 } })
        make_page(0x0010, { { " GREETZ: 0 ", 3, 0, 0, 7 } })
        make_page(0x0010, { { " GREETZ: 1 ", 3, 0, 1, 7 } })
        make_page(0x0010, { { " GREETZ: 2 ", 3, 0, 2, 7 } })
        make_page(0x0010, { { " GREETZ: 3 ", 3, 0, 3, 7 } })
