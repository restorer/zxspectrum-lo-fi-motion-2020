...
;
; INIT      initialization with module address in HL
; PLAY      play one quark
; MUTE      mute
; SETUP     setup and status flags
; CrPsPtr   pointer to current position value in PT3 module;
;           after INIT points to Postion0-1 (optimization)

            org (($ + 255) / 256) * 256

SETUP       DB 0    ; set bit0 to 1, if you want to play without looping
                    ; bit7 is set each time, when loop point is passed
CrPsPtr     DW 0    ; [CrPsPtr] - module_address - 200 = pattern_number
